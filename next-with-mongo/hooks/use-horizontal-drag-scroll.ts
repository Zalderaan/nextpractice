...
export function useHorizontalDragScroll<T extends HTMLElement>(ref: React.RefObject<T | null>) {
    ...
    React.useEffect(() => {
        ...
        const interactiveSelector = "a, button, input, textarea, select, [data-no-drag]";
